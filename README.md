...
Git command to clone this subset: `git clone --branch subset-1daac3f46ed6524a4afdf1e81f62093aab833e2e --single-branch https://github.com/AntilatencySDK/Release_3.4.0.git AntilatencySDK`
