...
Git command to clone this subset: `git clone --branch subset-016c0491b1f86a17a4d9b4f201db6a9a9498551d --single-branch https://github.com/AntilatencySDK/Release_3.4.0.git AntilatencySDK`
